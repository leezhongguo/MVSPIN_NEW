...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--num_epochs', type=int, default=20, help='Total number of training epochs')
        ...
        train.add_argument('--rot_factor', type=float, default=10, help='Random rotation in the range [-rot_factor, rot_factor]') 
        ...
        train.add_argument('--run_mvsmplify', default=False, action='store_true', help='Run MVSMPLify during training') 
        train.add_argument('--mvsmplify_threshold', type=float, default=100., help='Threshold for ignoring SMPLify fits during training') 
